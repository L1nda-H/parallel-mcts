...
if __name__ == "__main__":
    ...
    run_match("srun -N 2 --ntasks-per-node=1 ./build/go_engine --zobrist", "./pachi/pachi -t 1 -d0 -o pachilog.log threads=1,policy=ucb1,playout=light,prior=eqex=0,dynkomi=none,pondering=0,pass_all_alive", games=2)